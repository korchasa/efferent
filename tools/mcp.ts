...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "",
      "Two of those words are not the last word. Adding something new lands by itself, but",
      "changing or removing a record that already stands in Health waits for the phone's",
      "owner: such an item comes back awaitingApproval, and the phone answers again for the",
      "same edit once they have decided — applied if they said yes, declined if they said no.",
      "Read the edit again later rather than resending it.",
      "",
