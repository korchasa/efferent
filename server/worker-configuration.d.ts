/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=server/wrangler.jsonc server/worker-configuration.d.ts` (hash: cd54f50551aea157173b3cfddb626b59)
// Runtime types generated with workerd@1.20260825.1 2026-08-28 
